...
public:
    static Logger* CreateFileLogger(std::string strFilePath, 
            LogLevel level = LogLevel::INFO, bool bPrintTimeStamp = true) {
        return new FileLogger(strFilePath, level, bPrintTimeStamp);
    }
    static Logger* CreateConsoleLogger(LogLevel level = LogLevel::INFO,
            bool bPrintTimeStamp = true) {
        return new ConsoleLogger(level, bPrintTimeStamp);
    }
    static Logger* CreateUdpLogger(char *szHost, unsigned uPort, LogLevel level = LogLevel::INFO,
            bool bPrintTimeStamp = true) {
